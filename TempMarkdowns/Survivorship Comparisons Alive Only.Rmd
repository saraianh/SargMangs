...
# Read data
ALLDATA <- read_csv("C:\\Users\\sarai\\OneDrive\\Email attachments\\Documents\\UVI\\Thesis.Work\\SargMangs\\Data/Hutchinson_MonthlyMonitoring-MASTER3.csv")
...
ALLDATA <- ALLDATA %>%
  mutate(
    ...
    Treatment_Name = factor(
      Treatment_Name,
      levels = c("Soil", "Crushed glass (CG)", "Sargassum only (SG)", "1:3 CG to SG", "3:1 CG to SG")
    )
  )
```
