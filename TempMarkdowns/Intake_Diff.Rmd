...
params:
  rhma_path: "RHMA_IntakeData.csv"
  lara_path: "LARA_IntakeData.csv"
...
raw <- readr::read_delim(params$rhma_path, delim = ",", guess_max = 10000, show_col_types = FALSE)
...
lara_raw <- readr::read_delim(params$lara_path, delim = ",", guess_max = 10000, show_col_types = FALSE)
